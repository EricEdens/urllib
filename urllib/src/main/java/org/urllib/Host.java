...
/**
 * A Url's host, with encoding for the network and encoding for display.
 *
 * <table>
 * <tr>
 * <th>Type</td>
...
public interface Host {
  ...
  /**
   * Returns the Url's host, encoded so that it can be shown to a person (for example in a
